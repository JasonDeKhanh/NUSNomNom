...
function StallListEl(props) {
  ...
  return (
    <div
      ...
      className="md:max-w-content mx-4 my-4 h-40 cursor-pointer overflow-hidden rounded-2xl bg-[#ffffcc] transition-all duration-100 ease-in hover:scale-[1.01] 
      hover:bg-[#CCCC98] md:mx-2 md:min-w-min md:max-w-[32%] md:shrink-0 md:grow md:basis-1/3 xl:basis-1/4"
    >
      <div className="mx-2 flex h-full">
        ...
        <div className="ml-2 flex scroll-my-4 flex-col p-2">
          ...
          <span className="mt-1 text-sm font-medium lg:text-base lg:font-semibold">
            Opening Hours:
            <br />
            <p className="text-xs leading-relaxed">{stall.openingHours}</p>
          </span>
        </div>
      </div>
    </div>
